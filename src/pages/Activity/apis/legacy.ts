...
// import { FANS_POST, FANS_PAGE, IG_MEDIA, GROUP_PAGE } from "./facebook";
import { FANS_POST, FANS_PAGE } from "./facebook";
// import { GROUP_POST } from "@pages/MobileLiveRoom/apis/facebook";
...
export const duplicateActivityPost = async (
  url: string,
  activityId: string,
  postId: string,
  source: string,
...
export const deleteDummyActivityPost = async (
  url: string,
  activityId: string,
  postId: string,
  raw: string = "{}"
